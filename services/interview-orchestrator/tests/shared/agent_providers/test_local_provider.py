...
from interview_orchestrator.shared.agent_providers import LocalAgentProvider
...
async def test_get_context():
    ...
    context = await client.get_context("problem_clarification")
...
async def test_evaluate():
    ...
    evaluation = await client.evaluate_phase("get_problem", conversation_history)
...
@pytest.mark.asyncio
async def test_evaluate_with_high_coverage():
    ...
    evaluation = await client.evaluate_phase("problem_clarification", conversation_history)
...
@pytest.mark.asyncio
async def test_evaluate_with_low_coverage():
