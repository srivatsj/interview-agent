...
class AudioRecorderProcessor extends AudioWorkletProcessor {
  constructor() {
    super();
    // VAD parameters - VERY INSENSITIVE to avoid interrupting agent
    this.energyThreshold = 0.05; // Much higher - only loud, clear speech triggers
    this.speechDuration = 0.5;   // Require half second of continuous speech
    this.silenceDuration = 2.0;  // Allow 2 seconds of silence before stopping
